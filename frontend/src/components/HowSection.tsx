...
export function HowSection() {
  ...
  return (
    <section
      id="how"
      ref={sectionRef}
      className="section-pad md:py-14 border-b border-white/[0.08] bg-[#0E0E11] relative overflow-hidden md:min-h-[calc(100vh-56px)] md:flex md:flex-col md:justify-center"
    >
